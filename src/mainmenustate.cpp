...
namespace States {
	...
	MainMenu::MainMenu(GameWindow& gameWindow, std::shared_ptr<Ressources::Manager> ressources)
		: States::State(gameWindow), m_ressources(ressources), m_logoSprite(ressources->getTexture("logo")) {
			...
			gameLabel->connect(sf::Event::MouseButtonPressed, [this]() { changeGameState(States::Game); });
			...
			editorLabel->connect(sf::Event::MouseButtonPressed, [this]() { changeGameState(States::Editor); });
			...
			scoreLabel->connect(sf::Event::MouseButtonPressed, [this]() { changeGameState(States::Score); });
			...
			optionLabel->connect(sf::Event::MouseButtonPressed, [this]() { changeGameState(States::Options); });
			...
			quitLabel->connect(sf::Event::MouseButtonPressed, [&gameWindow]() { gameWindow.close(); });
			...
			m_profileLabel->connect(sf::Event::MouseButtonPressed, [this]() { changeGameState(States::Profile); });
