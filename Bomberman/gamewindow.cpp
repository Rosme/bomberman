...
void GameWindow::loadFirstGame() {
	boost::shared_ptr<States::State> firstGameState(new States::FirstGameState(*this, m_profileLoader));
...
boost::shared_ptr<Ressources::Manager> GameWindow::getRessourcesManager() {
	return m_ressources;
}
