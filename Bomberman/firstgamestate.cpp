...
namespace States {
	...
	FirstGameState::FirstGameState(GameWindow& gameWindow, Options::Loader& profileLoader)
		...
		m_profileName->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, m_profileName, true));
		...
		continueButton->connect(sf::Event::MouseButtonPressed, boost::bind(&States::State::changeGameState, boost::ref(*this), States::FirstTimeReady));
