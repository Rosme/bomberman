...
namespace States {
	...
	EditorState::EditorState(GameWindow& gameWindow, boost::shared_ptr<Ressources::Manager> ressources, DataModel::MapLoader& mapLoader)
		...
		m_currentSubstate(EditorState::None) {
			...
			newButton->connect(sf::Event::MouseButtonPressed, boost::bind(&DataModel::Map::resetMap, boost::ref(m_map)));
			...
			saveButton->connect(sf::Event::MouseButtonPressed, boost::bind(&States::EditorState::setCurrentSubstate, boost::ref(*this), EditorState::Save));
			...
			loadButton->connect(sf::Event::MouseButtonPressed, boost::bind(&States::EditorState::loadMapList, boost::ref(*this)));
			...
			quitButton->connect(sf::Event::MouseButtonPressed, boost::bind(&States::EditorState::changeGameState, boost::ref(*this), States::Menu));
			...
			m_mapNameEdit->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, boost::ref(m_mapNameEdit), true));
	...
	void EditorState::loadMapList() {
		...
		for(unsigned int i = 0, j = 1; i < mapList.size(); ++i) {
			...
			mapName->connect(sf::Event::MouseButtonPressed, boost::bind(&States::EditorState::loadMap, boost::ref(*this), mapName->getText()));
