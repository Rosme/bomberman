...
typedef boost::shared_ptr<States::State> Stateptr;

class GameWindow : boost::noncopyable {
private:
...
public:
	...
	boost::shared_ptr<Ressources::Manager> getRessourcesManager(); //Return the ressources manager
