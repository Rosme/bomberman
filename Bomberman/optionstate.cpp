...
namespace States {
	...
	OptionState::OptionState(GameWindow& gameWindow, Options::Loader& profileLoader)
		: States::State(gameWindow), m_profileLoader(profileLoader) {
			...
			lowerMusicLabel->connect(sf::Event::MouseButtonPressed, boost::bind(&States::OptionState::lowerMusic, boost::ref(*this)));
			...
			raiseMusicLabel->connect(sf::Event::MouseButtonPressed, boost::bind(&States::OptionState::raiseMusic, boost::ref(*this)));
			...
			lowerSoundLabel->connect(sf::Event::MouseButtonPressed, boost::bind(&States::OptionState::lowerSound, boost::ref(*this)));
			...
			raiseSoundLabel->connect(sf::Event::MouseButtonPressed, boost::bind(&States::OptionState::raiseSound, boost::ref(*this)));
			...
			m_upEdit->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, m_upEdit, true));
			...
			m_downEdit->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, m_downEdit, true));
			...
			m_leftEdit->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, m_leftEdit, true));
			...
			m_rightEdit->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, m_rightEdit, true));
			...
			m_pauseEdit->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, m_pauseEdit, true));
			...
			m_bombEdit->connect(sf::Event::MouseButtonPressed, boost::bind(&UI::EditText::setFullFocus, m_bombEdit, true));
